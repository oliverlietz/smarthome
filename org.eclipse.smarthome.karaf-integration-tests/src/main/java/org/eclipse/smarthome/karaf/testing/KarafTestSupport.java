package org.eclipse.smarthome.karaf.testing;
...
public abstract class KarafTestSupport {
    ...
    protected String featureRepositories() {
        return "mvn:org.eclipse.smarthome.karaf/org.eclipse.smarthome.karaf.features/0.8.0-SNAPSHOT/xml/features";
    }
    ...
    protected Option karafTestSupportBundle() {
        return streamBundle(
            bundle()
                ...
                .set(Constants.BUNDLE_SYMBOLICNAME, "org.eclipse.smarthome.karaf-integration-tests")
                .set(Constants.EXPORT_PACKAGE, "org.eclipse.smarthome.karaf.testing")
